/* eslint-disable */
const customStyle = (origin, pathname) => ({
  "version": 8,
  "name": "Positron",
  "metadata": {
    ...
    "openmaptiles:mapbox:source:url": [origin+pathname+"wroclaw/{z}/{x}/{y}.pbf"]
  },
  "sources": {
    "openmaptiles": {
      "type": "vector",
      // "url": "https://free.tilehosting.com/data/v3.json?key={key}",
      "tiles": [origin+pathname+"wroclaw/{z}/{x}/{y}.pbf"],
      "tileSize": 512
    }
  },
  "sprite": "https://openmaptiles.github.io/positron-gl-style/sprite",
  "glyphs": "https://free.tilehosting.com/fonts/{fontstack}/{range}.pbf?key=idd30rA1t6Uyfl6KtTZy",
  "layers": [
    {
      "id": "background",
      "type": "background",
